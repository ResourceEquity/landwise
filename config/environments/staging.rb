Rails.application.configure do
  ...
  config.cache_store = :redis_cache_store, { url: ENV['REDIS_CACHE_URL'], compress: true, driver: :hiredis }
  ...
  config.action_controller.asset_host = 'resourceequity-staging.herokuapp.com'

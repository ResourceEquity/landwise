...
CATEGORIES.each     { |title| Category.find_or_create_by(title: title.strip) }
JURISDICTIONS.each  { |title| Jurisdiction.find_or_create_by(title: title.strip) }
LANGUAGES.each      { |title| Language.find_or_create_by(title: title.strip) }
TOPICS.each         { |title| Topic.find_or_create_by(title: title.strip) }
COUNTRIES.each      { |title| Country.find_or_create_by(title: title.strip) }

Responsibility.find_or_create_by(title: 'Admin', locked: true)
Responsibility.find_or_create_by(title: 'Public', locked: true)
Responsibility.find_or_create_by(title: 'Restricted', locked: true)
Responsibility.find_or_create_by(title: 'Developer', locked: true)
...
@user.responsibilities << Responsibility.find_by(title: 'Developer')
